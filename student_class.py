...
sign_to_class = {'P': Podatkova(), 'ß': Shept(), 'C': Church(), '1': K1(), '0': K2(), 'I': IT(), 'V': PV(), 'Ø': Canteene(), '▓': Park()}
...
class Student:
    ...
    def move(self):
        ...
        if self.dest is None or random.random() < 0.15:
            self.path = []
    ...
    def set_new_destination(self, destination = Church()):
        '''
        Manually set a new destination for the student.
        Church is the default destination for conveniency.
        '''
