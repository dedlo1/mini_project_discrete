...
&emsp;Наша симуляція також містить канонічні івенти: сесія та прогулянка з паном Степаном. Консультацію з мат аналізу можна викдикати за допомогою деякої комбінації клавіш. Студенти з деяким шансом будуть йти за паном Степаном, який прямує за своїм звичайним маршрутом. Даний івент дуже позитивно відображається на загальних статах персонажів, тому його виклик покращує загальну ситуацію(все як і в житті).

&emsp;Також можна запустити спеціальну подію ‘сесія’, яка видалить всіх студентів, у яких шанс провалу більний за 80% від максимального. 
...
&emsp;Загалом було цікаво бачити, як знання, набуті під час проходження курсу дискретної математики пригоджаються для розв'язання цікавих завдань з програмування. Тема скінченних автоматів - потужний інструмент для моделювання різних важливих ситуацій, який гарантовано ще пригодить нам під час професійного зростання в майбутньому.

<p align="center">
  Розподіл роботи
</p> 

 - Богдан: клас студента, агроритм fsm
 - Артем: додаткові івенти
 - Василь: рух студентів
 - Іван: візуалізація, частина додаткових івентів
